...
describe("pokemon()",()=>{
    ...
    test("attackMessage should return correct message based of effectiveness", () => {
        const ash = new Trainer()
        const brock = new Trainer()
        const charmander1 = new Charmander()
        const squirtle = new Squirtle()
        ...
        const gymBattle = new Battle(ash,brock,'charmander','squirtle')
        gymBattle.fight()
        expect(gymBattle.fight()).toBe("charmander's attack wasn't very effective, squirtle's attack was super effective")
    })
    test("faintChecker method should return if pokemon fainted or not", () => {
        const ash = new Trainer()
        const brock = new Trainer()
        const charmander1 = new Charmander()
        const squirtle = new Squirtle()
        ...
        gymBattle.fight()
        gymBattle.fight()
        expect(gymBattle.fight()).toBe("charmander's attack wasn't very effective. squirtle fainted")
    })
})
